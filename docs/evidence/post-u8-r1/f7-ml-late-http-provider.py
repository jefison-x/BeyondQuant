...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        if count == 1:
            name, args = "byq_agent_run_start", {"role_id": "ml_researcher", "idempotency_key": f"late-agent-{phase}"}
        elif count == 2 and phase == 1:
            name, args = "byq_research_task_create", {"owner_principal": "ci-ml-late-http",
            ...
            name, args = "byq_ml_strategy_create", {"task_id": fields(results, "task_id")[-1],
