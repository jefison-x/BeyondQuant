...
| U7 生产晋升 | IN_PROGRESS | `.byq-worktrees/dsh-u7-promote-012rc1` / `chore/dsh-u7-promote-012rc1` | 原版生产恢复、私有备份及 105 表实际恢复通过；187 项根测试通过；见 `docs/evidence/dsh-012rc1/u7/EXECUTION.md` | U7.3 全量认证、PR 门禁、最终排空备份、受控部署尚待完成 |
