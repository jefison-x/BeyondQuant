...
（已并入 `main`），**ADR-0085 P2 审批与异步事件统一已合并**（已并入 `main`），当前唯一获授权实现切片是
**ADR-0085 P3 有界研究判断回合**。
...
<!-- byq:harness-continuation=adr-accepted-p0-merged-p1-merged-p2-merged-p3-current-version-0.9.1 -->
