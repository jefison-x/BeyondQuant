...
（已并入 `main`），当前唯一获授权实现切片是 **ADR-0085 P2 审批与异步事件统一**。
...
<!-- byq:harness-continuation=adr-accepted-p0-merged-p1-merged-p2-current-version-0.9.1 -->
