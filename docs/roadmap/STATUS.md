...
- Current completed phase: **Phase 16**
- Next phase: **Phase 17**
...
- Open architecture decisions: none for the Phase 16 product-api boundary;
...
- Phase 16 acceptance evidence covers a Gateway-owned Product API/BFF boundary,
  versioned OpenAPI contract, safe product error envelope, dashboard/data
  status seams, and a logical market-data migration dry-run manifest contract.
