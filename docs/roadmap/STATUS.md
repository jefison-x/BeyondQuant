...
- 维护执行：[DSH 0.1.2rc1 升级方案](DSH_012RC1_UPGRADE_PLAN.md) 的 U0 已 `VERIFIED`，维护者于
  ...
  U4 的 0.1.2rc1 候选适配已由 PR #255 合并。U5 已本地验证：T01-T37、真实候选进程/五角色委派、
  old/new 20-cycle benchmark、完整本地 CI 和固定 G1-G6 old/new live-model gate 已通过；T38-T40 留给 U6-U8。维护者已授权 U1–U8 串行开发、自动 push/Draft PR，并在 CI-green 后按
