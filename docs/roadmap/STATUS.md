...
**ADR-0085 P0 止损与事实一致性已合并**（已并入 `main`），当前唯一获授权实现切片是
**ADR-0085 P1 执行计划合同**。P0→P4 必须逐项、逐独立 PR 推进，前项合并后才开始后项。
...
<!-- byq:harness-continuation=adr-accepted-p0-merged-p1-current-version-0.9.1 -->
