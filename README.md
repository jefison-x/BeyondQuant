...
**Phase 85**：可靠 LightGBM、自动化通道和按需数据准备均已接入小巴；机器学习 V2 已实现可扩展能力
注册、purged walk-forward、确定性 Ridge JSON、冻结沪深300市场状态、独立专家 ModelBundle 与确定性路由。
Product API、模型研究页和小巴的 V2 入口将在下一独立阶段完成。
大范围数据准备按原子分片推进，
