...
**Phase 88**：可靠 LightGBM、自动化通道和按需数据准备均已接入小巴；机器学习 V2 已实现可扩展能力
...
PostgreSQL 反馈修订、隐私预览、审核/outbox 与分页 Product API；独立固定仓库 GitHub publisher 和
Product UI/MCP/小巴入口继续按 Phase 89–90 串行交付，普通用户仍无需配置 GitHub。
大范围数据准备按原子分片推进，
