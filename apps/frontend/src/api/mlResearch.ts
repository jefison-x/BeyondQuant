...
export interface MLStudySummary { artifact_id: string; task_id: string; task_title: string; status: string; created_at?: string; schema_version: string; name: string; learner_profile?: string; regime_enabled: boolean; horizon_sessions?: string; training_status?: string; prediction_status?: string; backtest_status?: string; stage: string }
...
export interface MLStudyDetail { schema_version: string; study: MLArtifact; approval_artifact_id?: string; training_runs: { runs: MLRun[]; total: number }; prediction_runs: { runs: MLRun[]; total: number }; backtests: { backtests: Array<Record<string, any>>; total: number }; artifacts: MLArtifact[] }
