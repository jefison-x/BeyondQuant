...
assert.equal((await fetchByqFeedbackSubmit("http://backend", "feedback_" + "a".repeat(32), { expected_version: 1, preview_hash: "a".repeat(64), disclosure_confirmed: true, idempotency_key: "submit-1" }, fakeFetch)).isError, false);
...
console.log("Feedback MCP contract PASS: owner-only create, preview and explicit submit");
